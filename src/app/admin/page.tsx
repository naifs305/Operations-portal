...
export default function AdminPage() {
  ...
  const handleExport = () => {
    ...
    a.href = url;
    a.download = `training-portal-backup-${new Date().toISOString().split('T')[0]}.json`;
        ...
        <main className="flex-1 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl border border-support-gray p-8 w-full max-w-md">
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-support-muted mt-1">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full px-4 py-3 border border-support-gray rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors text-center"
                  autoFocus
                />
                {passwordError && (
                  <p className="mt-2 text-sm text-red-500 text-center">{passwordError}</p>
                )}
              </div>
            ...
            <p className="mt-6 text-xs text-support-muted text-center">
              كلمة المرور الافتراضية: admin123
              <br />
              (يمكن تغييرها من الكود المصدري)
            </p>
          </div>
        </main>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-support-muted mt-1">
                  إدارة منصات البوابة وترتيبها
                </p>
              </div>
          ...
          <div className="mb-6 bg-gold/10 border border-gold/30 rounded-lg p-4">
            <p className="text-sm text-gray-700">
              <strong>ملاحظة:</strong> جميع التغييرات تُحفظ محلياً في المتصفح. استخدم خيار
              "تصدير البيانات" لحفظ نسخة احتياطية، و"استيراد البيانات" لاستعادتها.
            </p>
          </div>

          <PlatformList
            platforms={platforms}
            setPlatforms={handleUpdatePlatforms}
          />
        </div>
      </main>
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-600">
            سيتم حذف جميع التغييرات واستعادة المنصات الافتراضية. هل أنت متأكد؟
          </p>
